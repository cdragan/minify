...
{
    lza_decompress(live_layout->decomp_base,
                   live_layout->decomp_size,
                   live_layout->comp_data,
                   live_layout->comp_data_size);

    return live_layout->import_loader(live_layout);
}
